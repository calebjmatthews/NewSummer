import {
  ...
  faCloudSun, faFillDrip, faStar, faCircle, faCheckCircle, faHatWizard
...
fontAwesomeMap.set('circle', faCircle);
fontAwesomeMap.set('check-circle', faCheckCircle);
fontAwesomeMap.set('hat-wizard', faHatWizard);
